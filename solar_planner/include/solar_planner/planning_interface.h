...
public:
  ...
  */
  ...
  virtual double getHeuristic(const state &) const {
    std::cout<<"This is virtual Heuristic: "<< 0<<std::endl<<std::endl;
    return 0;
  }
  ...
  virtual bool isGoal(const state &) const {
    std::cout<<"This is virtual isGoal: "<< 0<<std::endl<<std::endl;
    return true;
  }
  ...
  virtual size_t stateToIndex(const state &) const {
    std::cout<<"This is virtual state to index: "<< 0<<std::endl<<std::endl;
    return 0;
  }
};
}
